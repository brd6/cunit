...
# define CU_ASSERT_STR(s1, s2, op, message, ...)			\
  CU_ASSERT_MSG(strcmp(s1 == NULL ? "" : s1, s2 == NULL ? "" : s2) op 0, message, ## __VA_ARGS__)
# define CU_ASSERT_STR_EQ(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, ==, message, ##____VA_ARGS__)
# define CU_ASSERT_STR_NE(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, !=, message, ##____VA_ARGS__)
# define CU_ASSERT_STR_LT(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, <, message, ##____VA_ARGS__)
# define CU_ASSERT_STR_LE(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, <=, message, ##____VA_ARGS__)
# define CU_ASSERT_STR_GT(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, >, message, ##____VA_ARGS__)
# define CU_ASSERT_STR_GE(str1, str2, message, ...) CU_ASSERT_STR(str1, str2, >=, message, ##____VA_ARGS__)
# define CU_ASSERT_PTR(ptr1, ptr2, op, message, ...)	\
  CU_ASSERT_MSG(ptr1 op ptr2, message, ## __VA_ARGS__)
